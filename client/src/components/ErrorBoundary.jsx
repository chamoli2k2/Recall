...
export default class ErrorBoundary extends Component {
  ...
  render() {
    ...
    return <div className="crash-screen" role="alert">
      ...
      <p>The rest of Recall is fine, and nothing you saved has been lost. Reloading usually clears it.</p>
      <div className="crash-actions">
        <button className="button primary" onClick={() => window.location.reload()}><RotateCcw size={16}/> Reload Recall</button>
