...
const FORMAT_NAMES = { apkg: 'Anki deck (.apkg)', 'anki-text': 'Anki plain-text export', csv: 'CSV / TSV', markdown: 'Markdown', json: `${BRAND.name} JSON` };
...
export default function ImportModal({ folder, onClose }) {
  ...
  return <Modal open onClose={onClose} title="Bring your cards along" description={`Import into ${folder.title} from Anki, a spreadsheet, Markdown notes, or a ${BRAND.name} export.`}>
