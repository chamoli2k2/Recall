import { Folder, Activity } from '../models/index.js';
...
export const save = async (req, res) => res.json({ folder: await folders.likeFolder(req.params.id, req.user, req.body.saved) });
