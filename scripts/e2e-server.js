#!/usr/bin/env node
// Boots a throwaway MongoDB replica set and the Recall API serving the built client, for Playwright.
...
const env = { ...process.env, PORT: String(port), MONGODB_URI: mongo.getUri('recall_e2e'), CLIENT_ORIGIN: `http://localhost:${port},http://127.0.0.1:${port}`, NODE_ENV: 'test' };
